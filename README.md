...
- **LiteFlow 追问裁决**：评分完成后，追问环节通过 LiteFlow 规则引擎驱动裁决链，串联 上下文加载 → 完成状态守卫 → 追问次数限制 → AI建议判断 → 低分判断 → 遗漏知识点判断 → 最终裁决 共 7 个决策节点，每个节点职责单一、可独立测试；
...
### 5. 知识腐化治理：面向 AI Coding 的 Skill 动态知识体系
